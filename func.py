...
tt = tweepy.Client(
    #Consumer Keys
    consumer_key= os.environ['DImpHCTCUHbGIoKLZsbAg59LH'],
    consumer_secret= os.environ['9ClQMOinOtpHIjE5WThlpoLMlElAWwYfQx2V27STZfXqz61fKt'],
    # Access Token and Secret
    access_token= os.environ['1720059598336569344-ZBgVD8EmEBOcivPmMDHTiKklXSsvod'],
    access_token_secret= os.environ['UTvadnzma2drbQ1KuAanqI3cM04krqUxd8xm0V2Lx6NYD'])
